...
public class SignupRestAPIController {
    ...
    public ModelAndView signup(HttpServletRequest request, HttpServletResponse response) {
        ...
        String modulus = (String) request.getAttribute("RSAModulus");
        String exponent = (String) request.getAttribute("RSAExponent");
        mav.addObject("RSAModulus", modulus);
        mav.addObject("RSAExponent", exponent);
